...
import { filterButtons, volunteerData } from "@/data/volunteers";
...
export default function Volunteers() {
  ...
  useEffect(() => {
    if (activeTab == "All") {
      setFilteredItem(volunteerData);
    } else {
      const filtered = volunteerData.filter((elm) =>
        ...
        <div className="bostami-page-content-wrap">
          <div className="section-wrapper pl-60 pr-60 pt-60">
            <div className="bostami-page-title-wrap mb-15">
              <h2 className="page-title">Volunteering</h2>
            </div>
          </div>

export const menuItems = [
  ...
  { id: 2, href: "/resume", icon: "fa-light fa-folder-user", text: "Resume" },
  { id: 3, href: "/projects", icon: "fa-light fa-briefcase", text: "Projects" },
  { id: 4, href: "/publications", icon: "fa-light fa-book", text: "Publications" },
  { id: 5, href: "/awards", icon: "fa-light fa-award", text: "Awards" },
  { id: 6, href: "/volunteers", icon: "fa-light fa-people", text: "Volunteers" },
  { id: 7, href: "https://blog.tnminh.com", icon: "fa-light fa-blog", text: "Blogs" },
  {
    id: 8,
    href: "/contact",
